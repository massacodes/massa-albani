(function (html) {
  ...
  const ssLightbox = function () {
    ...
    folioLinks.forEach(function (link) {
      ...
      // FIX: Only initialize basicLightbox if the href is an internal ID (starts with #)
      if (modalbox.startsWith("#")) {
    ...
    // Handle clicks only for links that have an associated modal instance
